...
public class QuickstartHost extends ServiceHost {
    ...
    static QuickstartHost startHost(String[] stringArgs, Arguments args) throws Throwable {
        ...
        h.start();
        h.log(Level.INFO,
                "Starting host [add-fields-validation] with args these args:%n[id=%s]%n[port=%d]%n[sandbox=%s]%n[peerNodes=%s]",
                h.getId(), h.getPort(), h.getStorageSandbox(), h.getInitialPeerHosts());
    ...
    public ServiceHost start() throws Throwable {
        ...
        super.startService(new EmployeeServiceTransformService());
