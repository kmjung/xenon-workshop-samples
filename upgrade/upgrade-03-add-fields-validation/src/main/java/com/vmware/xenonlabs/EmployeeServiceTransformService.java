...
import static com.vmware.xenonlabs.EmployeeService.Employee;
...
public class EmployeeServiceTransformService extends StatelessService {
    ...
    public void handlePost(Operation postOperation) {
        ...
        try {
            EmployeeService.validateManagerLink(state, this);
